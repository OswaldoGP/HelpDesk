    ...
    $.ajax({
        ...
        success:function(respuesta)  {
            ...
            if (respuesta == 1) {
                ...
                Swal.fire("XD","Actualizado con exito!","success");
...
function cambioEstatusUsuario(idUsuario, estatus){
    $.ajax({
        ...
        success: function(respuesta){
            ...
            if (respuesta == 1) {
                $('#tablaUsuariosLoad').load("usuarios/tablaUsuarios.php");
                Swal.fire("XD","Cambio de estatus con exito!","success");
            } else {
        ...
        if (result.isConfirmed) {
            $.ajax({
                ...
                success: function(respuesta) {
                    ...
                    if (respuesta == 1) {
                        $('#tablaUsuariosLoad').load("usuarios/tablaUsuarios.php");
                        Swal.fire("XD","Usuario eliminado con exito!","warning");
                    } else {
                        Swal.fire(":c","Error al eliminar usuario!" + respuesta,"error");
                    }
                }
            });
